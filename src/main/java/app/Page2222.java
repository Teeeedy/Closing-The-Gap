...
public class Page2222 implements Handler {
    public static final String URL = "/page11.html";
    ...
    public void handle(Context context) throws Exception {
        ...
        html = html + "<head>";
        html = html + "<link rel='stylesheet' type='text/css' href='Page2222.css' />";
        html += "</head>";
        html = html + "<body>";
        ...
        html += "<h1>Househould weekly income by Indigenous Status</h1>";
